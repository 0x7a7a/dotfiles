return {
  ...
  config = function()
    ...
    Keymap('n', '<leader>?', '<cmd>lua require("fzf-lua").oldfiles()<cr>', { desc = '[?] Find recently opened files' })
    Keymap(
      'n',
      '<leader>/',
    ...
    Keymap('n', '<leader>sv', '<cmd>lua require("fzf-lua").grep_visual()<cr>', { desc = '[S]earch [V]isual Selection' })
