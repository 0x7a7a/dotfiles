# Generated by Powerlevel10k configuration wizard on 2019-09-25 at 02:47 CST.
...
# slanted separators, blurred heads, flat tails, 2 lines, disconnected, left frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_DOCKER_MACHINE_FOREGROUND=227
}
